...
<link href="${pageContext.request.contextPath}/bbboard1/css/contentstyle.css" rel="stylesheet" type="text/css">
...
<br>
<form method="post" name="content" action="${pageContext.request.contextPath }/bbboard1/comment.do?num=${num}&pageNum=${pageNum}&bn=${bn}"
...
<c:choose>
	...
	<table class="contenttable">
		...
		<tr>
			...
			<th>파일</th>
			<td>
			<a href="${pageContext.request.contextPath}/bbboard1/download.do?num=${article.num}&pageNum=${pageNum}&bn=${bn}">
		...
		<c:when test="${article.mem eq '2' and login eq '1' and article.writer eq logNick}">
				...
				onclick="document.location.href='${pageContext.request.contextPath}/bbboard1/updateForm.do?num=${ article.num }&pageNum=${pageNum}&bn=${bn }'">
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" value="삭 제"
				onclick="document.location.href='${pageContext.request.contextPath}/bbboard1/deleteForm.do?num=${article.num}&pageNum=${pageNum}&bn=${bn }'">
				&nbsp;&nbsp;&nbsp;&nbsp;
		</c:when>
...
<table class="commenttable">
	...
	onClick="document.location.href='${pageContext.request.contextPath}/bbboard1/CommentDeleteForm.do?num=${article.num}&pageNum=${pageNum}&bn=${bn}&cnum=${comment.num}'">
	</c:when>
