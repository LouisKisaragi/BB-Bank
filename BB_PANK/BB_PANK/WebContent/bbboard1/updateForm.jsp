...
<b>글수정</b>
	...
	<form method="post" name="writeForm" action="${pageContext.request.contextPath}/bbboard1/updatePro.do?pageNum=${pageNum}&bn=${bn}"
				...
				<tr>
					<td colspan="3" class="attr">
						...
						<input type="button" value="목록보기" 
								onclick="window.location='${pageContext.request.contextPath}/bbboard1/list.do?pageNum=${pageNum}&bn=${bn}'">
					</td>
				</tr>
			</table>
	</form>
