...
<section>
    ...
    <div class="row">
                                    ...
                                    <c:forEach var="article" items="${articleList1}">
                                        ...
                                        <td>
											...
											<td class="titletd" >
												...
												<a href="${ pageContext.request.contextPath}/bbboard1/content.do?num=${article.num}&pageNum=${currentPage}&bn=${bn1}">
												${ article.subject }</a>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <a class="nav-link" href="${pageContext.request.contextPath}/bbboard1/list.do?pageNum=1&bn=4">
                                    ...
                                    <c:forEach var="article" items="${articleList4}">
                                        ...
                                        <td>
											...
											<td class="titletd" >
												...
												<a href="${ pageContext.request.contextPath}/bbboard1/content.do?num=${article.num}&pageNum=${currentPage}&bn=${bn4}">
												${ article.subject }</a>
												<c:if test="${ article.readcount >= 20 }">
												<img src = "${ pageContext.request.contextPath}/bbboard1/images/hot.gif">
												</c:if>		
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                         <a class="nav-link" href="${pageContext.request.contextPath}/bbboard1/list.do?pageNum=1&bn=2">
                                    ...
                                    <c:forEach var="article" items="${articleList2}">
                                        ...
                                        <td>
											...
											<td class="titletd" >
												...
												<a href="${ pageContext.request.contextPath}/bbboard1/content.do?num=${article.num}&pageNum=${currentPage}&bn=${bn2}">
												${ article.subject }</a>
												<c:if test="${ article.readcount >= 20 }">
												<img src = "${ pageContext.request.contextPath}/bbboard1/images/hot.gif">
												</c:if>		
                                    ...
                                    <c:forEach var="article" items="${articleList5}">
                                        ...
                                        <td>
											...
											<td class="titletd" >
												...
												<a href="${ pageContext.request.contextPath}/bbboard1/content.do?num=${article.num}&pageNum=${currentPage}&bn=${bn5}">
												${ article.subject }</a>
												<c:if test="${ article.readcount >= 20 }">
												<img src = "${ pageContext.request.contextPath}/bbboard1/images/hot.gif">
												</c:if>		
