...
public class FindPassSendAction implements CommandAction{
	...
	public String requestPro(
		...
		int check = dbPro.MemberPassFind(id,email);
		System.out.println(check);
		if(check==1){//해당 기록이 있을때
		...
		return "/bbmember/findPassSend.jsp";	//해당 뷰 경로 반환
	}
