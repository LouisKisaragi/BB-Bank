...
import bb.board.model3.CommentDao;
import bb.board.model3.CommentDto;

public class _3CommentAction implements CommandAction{
	...
	int ref,depth,step;
		...
		return "/bbboard3/commentPro.jsp";	//해당 뷰 경로 반환
	}
}
