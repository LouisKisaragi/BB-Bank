...
<b>글쓰기</b>
<br></br>
<form method="post" name="writeForm" action="${pageContext.request.contextPath}/board/writePro.do?pageNum=${pageNum }&bn=${bn}"  enctype="multipart/form-data"
	...
	<table class="board">
		...
		<tr>
			<td colspan="3" class="attr">
				...
				<input type="button" value="목록" onclick="window.location='${pageContext.request.contextPath}/board/list.do?pageNum=${pageNum }&bn=${bn}'">
			</td>
		</tr>
	</table>
</form>
