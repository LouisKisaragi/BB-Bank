...
<title>게시판</title>
<link href="${pageContext.request.contextPath}/board/css/style.css"
...
<table class="listtable">
	...
	<tr>
		...
		<td class="titletd" >
			...
			<a href="${ pageContext.request.contextPath}/board/content.do?num=${article.num}&pageNum=${currentPage}&bn=${bn}">
			${ article.subject }</a>
...
<form method="post" name="search" action="${pageContext.request.contextPath}/board/list.do?pageNum=${pageNum }&bn=${bn}">
...
<c:if test="${count > 0 }">
	...
	<a href="${pageContext.request.contextPath}/board/list.do?pageNum=${startPage - pageBlock}&bn=${bn}&keyField=${keyField}&keyWord=${keyWord}">이전</a>
	</c:if>
	<c:forEach var="i" begin="${startPage}" end="${endPage}">
		<a href="${pageContext.request.contextPath}/board/list.do?pageNum=${i}&bn=${bn}&keyField=${keyField}&keyWord=${keyWord}">[${i}]</a>
	</c:forEach>
	
	<c:if test="${endPage < pageCount}">
		<a href="${pageContext.request.contextPath}/board/list.do?pageNum=${startPage + pagBlock}&bn=${bn}&keyField=${keyField}&keyWord=${keyWord}">다음</a>
	</c:if>
</c:if>
</td></tr>
</table>
