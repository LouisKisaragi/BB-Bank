...
<title>게시판</title>
<script src="${pageContext.request.contextPath}/freeboard/script.js"></script>
<link href="${pageContext.request.contextPath}/freeboard/css/style.css"
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/freeboard/css/writeFormstyle.css"
	rel="stylesheet" type="text/css" />
</head>
<body>
	<section>
		...
		<article>
			<form method="post" name="writeForm"
				action="${pageContext.request.contextPath}/board/updatePro.do?pageNum=${pageNum}&bn=${bn}"
